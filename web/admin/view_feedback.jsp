	...
	<div class="container-fluid">
		<table class="table table-striped">
			...
			<tbody>
				...
				List<Feedback> list = dao.getAllFeedbackByService(id);

				UserDAO dao2 = new UserDAOImpl(DBConnect.getConn());
				ServiceDAO dao3 = new ServiceDAOImpl(DBConnect.getConn());

				int i = 0;

				for (Feedback f : list) {
					User user = dao2.getUserById(f.getUserId());
					ServiceDtls service = dao3.getServiceById(f.getServiceId());
					i++;
				%>
				<tr>
					<td><%=i%></td>
