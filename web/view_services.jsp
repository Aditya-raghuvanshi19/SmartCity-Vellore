	...
	<div class="container p-3">
		...
		<div class="row">
			<div class="col-md-6 text-center p-5 border bg-white paint-card">
				<img src="service/<%=b.getPhotoName()%>"
					style="height: 250px; width: 200px"><br>

			</div>

			<div class="col-md-6  p-5 border bg-white paint-card">
				<h4 class="fs-3"><%=b.getServiceName()%></h4>
				<h5 class="mt-2">Service Details :</h5>
				<p>
					Phone No. :
					<%=b.getPhone()%>
					<br> Location :
				...
				<div class=" text-center p-3">
					...
					%>
					<a href='cart?bid=<%=b.getServiceId()%>&&uid=<%=u.getId()%>&&ca=<%=b.getCategory()%>' class='btn btn-primary btn-sm ml-2 col-md-12'>
                                            <% if(b.getCategory().equals("Tourism")){
                                            out.print("");
                                                out.print("<i class='fas fa-cart-plus'></i> Book Now");
                                                }
                                            %>
                                            
                                        </a>
						<script> 
                                                    var cat= "<%=b.getCategory()%>";
                                                    if(cat==="Tourism"){
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<%
					ServiceDAO dao2 = new ServiceDAOImpl(DBConnect.getConn());
					UserDAO dao3 = new UserDAOImpl(DBConnect.getConn());
					List<Feedback> list = dao2.getAllFeedbackByService(bid);
